 ...
 *     "add-form" = "/admin/content/message/add/{message_type}",
 *     "add-page" = "/admin/content/message/add",
 *     "canonical" = "/admin/content/message/{message}",
 *     "edit-form" = "/admin/content/message/{message}/edit",
 *     "delete-form" = "/admin/content/message/{message}/delete",
 *   },
